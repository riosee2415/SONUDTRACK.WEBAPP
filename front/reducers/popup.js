...
export const initailState = {
  ...
  //
  st_popupSortUpdateLoading: false,
  st_popupSortUpdateDone: false,
  st_popupSortUpdateError: null,
  //
  st_popupImageUpdateLoading: false,
  st_popupImageUpdateDone: false,
  st_popupImageUpdateError: null,
  //
  st_popupHistoryLoading: false,
  st_popupHistoryDone: false,
  st_popupHistoryError: null,
};
...
export const POPUP_SORT_UPDATE_REQUEST = "POPUP_SORT_UPDATE_REQUEST";
export const POPUP_SORT_UPDATE_SUCCESS = "POPUP_SORT_UPDATE_SUCCESS";
export const POPUP_SORT_UPDATE_FAILURE = "POPUP_SORT_UPDATE_FAILURE";

export const POPUP_IMAGE_UPDATE_REQUEST = "POPUP_IMAGE_UPDATE_REQUEST";
export const POPUP_IMAGE_UPDATE_SUCCESS = "POPUP_IMAGE_UPDATE_SUCCESS";
export const POPUP_IMAGE_UPDATE_FAILURE = "POPUP_IMAGE_UPDATE_FAILURE";

export const POPUP_HISTORY_REQUEST = "POPUP_HISTORY_REQUEST";
export const POPUP_HISTORY_SUCCESS = "POPUP_HISTORY_SUCCESS";
export const POPUP_HISTORY_FAILURE = "POPUP_HISTORY_FAILURE";
...
const reducer = (state = initailState, action) =>
  produce(state, (draft) => {
    switch (action.type) {
      ...
      ///////////////////////////////////////////////////////
      case POPUP_SORT_UPDATE_REQUEST: {
        draft.st_popupSortUpdateLoading = true;
        draft.st_popupSortUpdateDone = false;
        draft.st_popupSortUpdateError = null;
        break;
      }
      case POPUP_SORT_UPDATE_SUCCESS: {
        draft.st_popupSortUpdateLoading = false;
        draft.st_popupSortUpdateDone = true;
        draft.st_popupSortUpdateError = null;
        break;
      }
      case POPUP_SORT_UPDATE_FAILURE: {
        draft.st_popupSortUpdateLoading = false;
        draft.st_popupSortUpdateDone = false;
        draft.st_popupSortUpdateError = action.error;
        break;
      }
      ///////////////////////////////////////////////////////

      case POPUP_IMAGE_UPDATE_REQUEST: {
        draft.st_popupImageUpdateLoading = true;
        draft.st_popupImageUpdateDone = false;
        draft.st_popupImageUpdateError = null;
        break;
      }
      case POPUP_IMAGE_UPDATE_SUCCESS: {
        draft.st_popupImageUpdateLoading = false;
        draft.st_popupImageUpdateDone = true;
        draft.st_popupImageUpdateError = null;
        draft.uploadImagePath = null;
        break;
      }
      case POPUP_IMAGE_UPDATE_FAILURE: {
        draft.st_popupImageUpdateLoading = false;
        draft.st_popupImageUpdateDone = false;
        draft.st_popupImageUpdateError = action.error;
        break;
      }
      ///////////////////////////////////////////////////////

      case POPUP_HISTORY_REQUEST: {
        draft.st_popupHistoryLoading = true;
        draft.st_popupHistoryDone = false;
        draft.st_popupHistoryError = null;
        break;
      }
      case POPUP_HISTORY_SUCCESS: {
        draft.st_popupHistoryLoading = false;
        draft.st_popupHistoryDone = true;
        draft.st_popupHistoryError = null;
        draft.history = action.data;
        break;
      }
      case POPUP_HISTORY_FAILURE: {
        draft.st_popupHistoryLoading = false;
        draft.st_popupHistoryDone = false;
        draft.st_popupHistoryError = action.error;
        break;
      }
      ///////////////////////////////////////////////////////
