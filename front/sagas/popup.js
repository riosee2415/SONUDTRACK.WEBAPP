...
import {
  ...
  POPUP_SORT_UPDATE_SUCCESS,
  POPUP_SORT_UPDATE_FAILURE,
  //
  POPUP_IMAGE_UPDATE_REQUEST,
  POPUP_IMAGE_UPDATE_SUCCESS,
  POPUP_IMAGE_UPDATE_FAILURE,
  //
  POPUP_HISTORY_REQUEST,
  POPUP_HISTORY_SUCCESS,
  POPUP_HISTORY_FAILURE,
} from "../reducers/popup";
...
async function popupDeleteAPI(data) {
  return await axios.post(`/api/popup/delete`, data);
}
...
// SAGA AREA ********************************************************************************************************
// ******************************************************************************************************************
async function popupSortUpdateAPI(data) {
  return await axios.post(`/api/popup/sort/update`, data);
}

function* popupSortUpdate(action) {
  try {
    const result = yield call(popupSortUpdateAPI, action.data);

    yield put({
      type: POPUP_SORT_UPDATE_SUCCESS,
      data: result.data,
    });
  } catch (err) {
    console.error(err);
    yield put({
      type: POPUP_SORT_UPDATE_FAILURE,
      error: err.response.data,
    });
  }
}
...
// SAGA AREA ********************************************************************************************************
// ******************************************************************************************************************
async function popupImageUpdateAPI(data) {
  return await axios.post(`/api/popup/image/update`, data);
}

function* popupImageUpdate(action) {
  try {
    const result = yield call(popupImageUpdateAPI, action.data);

    yield put({
      type: POPUP_IMAGE_UPDATE_SUCCESS,
      data: result.data,
    });
  } catch (err) {
    console.error(err);
    yield put({
      type: POPUP_IMAGE_UPDATE_FAILURE,
      error: err.response.data,
    });
  }
}
...
// SAGA AREA ********************************************************************************************************
// ******************************************************************************************************************
async function popupHistoryAPI(data) {
  return await axios.post(`/api/popup/history/list`, data);
}

function* popupHistory(action) {
  try {
    const result = yield call(popupHistoryAPI, action.data);

    yield put({
      type: POPUP_HISTORY_SUCCESS,
      data: result.data,
    });
  } catch (err) {
    console.error(err);
    yield put({
      type: POPUP_HISTORY_FAILURE,
      error: err.response.data,
    });
  }
}
...
function* watchPopupSortUpdate() {
  yield takeLatest(POPUP_SORT_UPDATE_REQUEST, popupSortUpdate);
}

function* watchPopupImageUpdate() {
  yield takeLatest(POPUP_IMAGE_UPDATE_REQUEST, popupImageUpdate);
}

function* watchPopupHistory() {
  yield takeLatest(POPUP_HISTORY_REQUEST, popupHistory);
}
...
export default function* bannerSaga() {
  yield all([
    ...
    fork(watchPopupSortUpdate),
    fork(watchPopupImageUpdate),
    fork(watchPopupHistory),
    //
  ]);
}
