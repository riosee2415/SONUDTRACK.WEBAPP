...
const buyRequestRouter = require("./routers/buyRequestRouter");
const userBuyStatusRouter = require("./routers/userBuyStatusRouter");
...
app.use("/api/status", userBuyStatusRouter);
